 ...
 *
 * @package rtCamp\Publish_With_AI\Modules\OAuth\Well_Known
 */

declare( strict_types = 1 );

namespace rtCamp\Publish_With_AI\Modules\OAuth\Well_Known;
...
class Protected_Resource {
	/**
	 * Register rewrite rules and request handler.
	 */
