# Contributing to Publishio

Thank you for your interest in contributing to Publishio! We welcome contributions from the community to help improve the project. This document outlines how you can contribute, including reporting issues, submitting code, and our code of conduct.
...
If you find a bug or have a feature request, please open an issue in the [GitHub Issues](https://github.com/rtCamp/publishio) section. Provide as much detail as possible, including:
...
> [!TIP]
>
> **Note**: Before opening a new issue, please search the [GitHub Issues](https://github.com/rtCamp/publishio/issues) to see if a similar issue has already been reported.
>
...
3. **Write tests**: Add and update the necessary Integration/Functional/etc. tests for your changes to ensure that everything works correctly.
...
We appreciate your time and contributions to Publishio. Your efforts help make this project better for everyone!
