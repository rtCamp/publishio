...
class Get_Pattern {
	...
	public function register(): void {
		wp_register_ability(
			'rtcamp-publish-with-ai/get-pattern',
			[
				'label'               => __( 'Get Pattern by Name', 'rtcamp-publish-with-ai' ),
				'category'            => \rtCamp\Publish_With_AI\Modules\Abilities\Categories\Patterns::SLUG,
				'description'         => __( 'Returns full details of a single block pattern including its block markup content.', 'rtcamp-publish-with-ai' ),
				'input_schema'        => [
					'type'                 => 'object',
					'required'             => [ 'name' ],
					'properties'           => [
